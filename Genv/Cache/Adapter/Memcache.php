 ...
 * yourself; instead, use Genv_Cache as the frontend for it and specify
 * 'Genv_Cache_Memcache' in the config keys as the 'adapter' value.
 * 
 ...
 * 
 */
class Genv_Cache_Adapter_Memcache extends Genv_Cache_Adapter
{
    /**
     * 
     ...
     * 
     */
    protected $_Genv_Cache_Adapter_Memcache = array(
        'host' => 'localhost',
        'port' => 11211,
        'timeout' => 1,
        'pool' => array(),
