 ...
 * 
 */
class Genv_Cache_Adapter_Session extends Genv_Cache_Adapter
{
    /**
     * 
     * Cache entries.
    ...
    protected function _postConstruct()
    {
        ...
        $this->_prefix = null;
        if (! $prefix) {
            $prefix = 'Genv_Cache_Adapter_Session';
        }
        
        // a session store for entries
        $this->_entries = Genv::factory('Genv_Session', array(
            'class' => $prefix . '__entries',
        ));
        
        // a session store for expires
        $this->_expires = Genv::factory('Genv_Session', array(
