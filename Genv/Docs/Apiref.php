 ...
 * @category Genv
 * 
 * @package Genv_Docs Tools for building API documentation from source code.
 * 
 ...
 * 
 */
class Genv_Docs_Apiref extends Genv_Base
{
    /**
     * 
     * Default configuration values.
     * 
     * @config dependency phpdoc A Genv_Docs_Phpdoc dependency.
     * 
     * @config dependency log A Genv_Log dependency.
     * 
     ...
     * 
     */
    protected $_Genv_Docs_Apiref = array(
        'phpdoc'  => null,
        'log'     => array(
            'adapter' => 'Genv_Log_Adapter_Echo',
            'format'  => '%m',
        ),
        'unknown' => 'void',
    );
    ...
    protected function _postConstruct()
    {
        ...
        // PHPDoc parser
        $this->_phpdoc = Genv::dependency(
            'Genv_Docs_Phpdoc',
            $this->_config['phpdoc']
        );
        
        // Logger
        $this->_log = Genv::dependency(
            'Genv_Log',
            $this->_config['log']
        );
    }
    ...
    {
        $map = Genv::factory('Genv_Class_Map');
        $map->setBase($base);
    ...
    /**
     * 
     * Adds the Genv configuration keys for a given class.
     * 
     * @param string $class The class name.
     * 
     * @return void
     ...
     * 
     * @param array $tech A technical information array derived from Genv_Docs_Phpdoc.
     * 
