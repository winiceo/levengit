 ...
 * Genv_Request represents the PHP request environment superglobals (including
 * $_SERVER, $_ENV, $_POST, etc).
 * 
 * Here is an example request process:
 * 
 * {{code: php
 *     $request = Genv::factory('Genv_Http_Request');
 *     
 ...
 * 
 */
abstract class Genv_Http_Request_Adapter extends Genv_Base {
     ...
     * 
     */
    protected $_Genv_Http_Request_Adapter = array(
        'charset'         => 'utf-8',
        'content_type'    => null,
        'max_redirects'   => null,
        'proxy'           => null,
     ...
     * 
     * @return Genv_Http_Request_Adapter This adapter object.
     * 
     */
    ...
    {
        $allowed = array(
            Genv_Http_Request::METHOD_GET,
            Genv_Http_Request::METHOD_POST,
            Genv_Http_Request::METHOD_PUT,
            Genv_Http_Request::METHOD_DELETE,
            Genv_Http_Request::METHOD_TRACE,
            Genv_Http_Request::METHOD_OPTIONS,
            Genv_Http_Request::METHOD_TRACE,
            Genv_Http_Request::METHOD_COPY,
            Genv_Http_Request::METHOD_LOCK,
            Genv_Http_Request::METHOD_MKCOL,
            Genv_Http_Request::METHOD_MOVE,
            Genv_Http_Request::METHOD_PROPFIND,
            Genv_Http_Request::METHOD_PROPPATCH,
            Genv_Http_Request::METHOD_UNLOCK
        );
     ...
     * 
     * @param string|Genv_Uri $spec The URI for the proxy server.
     * 
     * @return Genv_Http_Request_Adapter This adapter object.
     * 
     */
     ...
     * 
     * @param Genv_Uri|string $spec The referer URI.
     * 
     * @return Genv_Http_Request_Adapter This adapater object.
     * 
     */
    public function setReferer($spec)
    {
        if ($spec instanceof Genv_Uri) {
            ...
            $this->_referer = Genv::factory('Genv_Uri', array('uri' => $spec));
        }
        return $this;
    }
     ...
     * 
     * @param Genv_Uri|string $spec The URI for the request.
     * 
     * @return Genv_Http_Request_Adapter This adapter object.
     * 
     */
    public function setUri($spec)
    {
        if ($spec instanceof Genv_Uri) {
            ...
            $this->_uri = Genv::factory('Genv_Uri', array('uri' => $spec));
        }
    ...
    /**
     * 
     * Fetches the last Genv_Http_Response object from the specified URI.
     * 
     * @return Genv_Http_Response
     * 
     */
    ...
    /**
     * 
     * Fetches all Genv_Http_Response objects from the specified URI (this
    ...
    public function fetchAll()
    {
        ...
        foreach ($headers as $header) {
            ...
            if ($pos === false && $is_http) {
                ...
                $i ++;
                $response[$i] = Genv::factory('Genv_Http_Response');
     ...
     * 
     * @param Genv_Uri $uri The URI get a response from.
     * 
    ...
    protected function _prepareRequest()
    {
        ...
        $is_get  = ($this->_method == Genv_Http_Request::METHOD_GET);
        $is_post = ($this->_method == Genv_Http_Request::METHOD_POST);
        $is_put  = ($this->_method == Genv_Http_Request::METHOD_PUT);
        ...
        foreach ($list as $key => $set) {
            settype($set, 'array');
            foreach ($set as $val) {
                $headers[] = Genv_Mime::headerLine($key, $val);
            }
        }
        ...
        if ($this->_cookies) {
            ...
            $headers[] = Genv_Mime::headerLine('Cookie', implode(';', $val));
        }
