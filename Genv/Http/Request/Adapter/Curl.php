 ...
 * 
 */
class Genv_Http_Request_Adapter_Curl extends Genv_Http_Request_Adapter
{
    ...
    protected function _prepareCurlHandle($uri, $headers, $content)
    {
         ...
         */
        switch ($this->_method) {
        case Genv_Http_Request::METHOD_GET:
            curl_setopt($ch, CURLOPT_HTTPGET, true);
            break;
        case Genv_Http_Request::METHOD_POST:
            curl_setopt($ch, CURLOPT_POST, true);
            break;
        case Genv_Http_Request::METHOD_PUT:
            curl_setopt($ch, CURLOPT_PUT, true);
            break;
        case Genv_Http_Request::METHOD_HEAD:
        ...
        $send_content = $this->_method == Genv_Http_Request::METHOD_POST
                     || $this->_method == Genv_Http_Request::METHOD_PUT;
