 ...
 * 
 */
class Genv_Log_Adapter_Firephp extends Genv_Log_Adapter {
     ...
     * 
     * @config dependency response A Genv_Http_Response dependency injection.
     * 
     * @var array
     * 
     */
    protected $_Genv_Log_Adapter_Firephp = array(
        'events'   => '*',
    ...
    /**
     * 
     * The Genv_Http_Response where headers will be set.
     * 
     * @var Genv_Http_Response
     * 
     */
    protected $_response;
    ...
    protected function _postConstruct()
    {
        ...
        $this->_response = Genv::dependency(
            'Genv_Http_Response',
            $this->_config['response']
        );
        
        $this->_json = Genv::factory('Genv_Json');
