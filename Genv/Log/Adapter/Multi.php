 ...
 *     $config = array(
 *         'adapter' => 'Genv_Log_Adapter_Multi', // could also be a dependency object?
 *         'adapters' => array(
 *             array(
 ...
 * 
 */
class Genv_Log_Adapter_Multi extends Genv_Log_Adapter
{
    /**
     * 
     ...
     * 
     */
    protected $_Genv_Log_Adapter_Multi = array(
        'adapters' => array(
            array(
    ...
    protected function _postConstruct()
    {
        ...
        foreach ($this->_config['adapters'] as $config) {
            ...
            $this->_adapters[] = Genv::factory($class, $config);
        }
    }
