 ...
 * @category Genv
 * 
 * @package Genv_Mail Email-sending tools.
 * 
 ...
 * 
 */
class Genv_Mail_Message extends Genv_Base
{
    /**
     * 
     ...
     * 
     * @config dependency transport A Genv_Mail_Transport dependency injection, for use 
     ...
     * 
     */
    protected $_Genv_Mail_Message = array(
        'boundary'    => null,
        'charset'     => 'utf-8',
        'encoding'    => '8bit',
        'crlf'        => "\r\n",
    ...
    /**
     * 
     * The Genv_Mail_Message_Part for the "text/html" portion of the message.
     * 
     * @var Genv_Mail_Message_Part
     * 
     */
    ...
    /**
     * 
     * The Genv_Mail_Message_Part for the "text/plain" portion of the message.
     * 
     * @var Genv_Mail_Message_Part
     * 
     */
    ...
    /**
     * 
     * A Genv_Mail_Transport dependency object.
     * 
     * @var Genv_Mail_Transport_Adapter
     * 
     */
    ...
    protected function _postConstruct()
    {
        ...
        if ($this->_config['transport']) {
            $this->_transport = Genv::dependency(
                'Genv_Mail_Transport',
    ...
    /**
     * 
     * Sets the Genv_Mail_Transport dependency.
     * 
     * @param Genv_Mail_Transport_Adapter $transport The transport adapter.
     * 
     * @return Genv_Mail_Message
     * 
     */
     ...
     * 
     * @return Genv_Mail_Message This object.
     * 
     */
    ...
    {
        // create the part
        $part = Genv::factory('Genv_Mail_Message_Part');
    ...
    /**
     * 
     * Returns the Genv_Mail_Message_Part for the plain-text portion.
     * 
     * @return Genv_Mail_Message_Part
     * 
     */
    ...
    /**
     * 
     * Returns the Genv_Mail_Message_Part for the HTML portion.
     * 
     * @return Genv_Mail_Message_Part
     * 
     */
    ...
    /**
     * 
     * Attaches a Genv_Mail_Message_Part to the message.
     * 
     * @param Genv_Mail_Message_Part $part The part to add as an attachment.
     * 
     * @return Genv_Mail_Message This object.
     * 
     */
     ...
     * uses the Genv_Mail_Message_Part default $type.
     * 
     * @return Genv_Mail_Message This object.
     * 
     */
    ...
    public function addHeader($label, $value, $replace = true)
    {
        ...
        $label = Genv_Mime::headerLabel($label);
    ...
    public function fetchHeaders()
    {
        ...
        foreach ($headers as $key => $val) {
            ...
            $val[0] = Genv_Mime::headerLabel($val[0]);
            $headers[$key][1] = Genv_Mime::headerValue(
                $val[0],
                $val[1],
                $this->_charset,
                $this->_crlf
    ...
    public function fetchContent()
    {
        ...
        if ($this->_text && $this->_html && $this->_atch) {
            ...
            $alt = Genv::factory('Genv_Mail_Message_Part');
     ...
     * 
     * @throws Genv_Mail_Message_Exception_NoTransport
     * 
     */
