 ...
 * 
 */
class Genv_Mail_Transport_Adapter_Smtp extends Genv_Mail_Transport_Adapter
{
    /**
     * 
     * Default configuration values.
     * 
     * @config dependency smtp A Genv_Smtp_Adapter dependency.  Default is 'smtp',
     *   which means to use the registered object named 'smtp'.
     * 
     * @var array
     * 
     */
    protected $_Genv_Mail_Transport_Adapter_Smtp = array(
        'smtp' => 'smtp',
    );
     ...
     * 
     * @param Genv_Smtp_Adapter $smtp The SMTP adapter.
     * 
     * @return void
     * 
     */
    public function setSmtp(Genv_Smtp_Adapter $smtp)
    {
        $this->_smtp = $smtp;
    }
    ...
    /**
     * 
     * Sends the Genv_Mail_Message through an SMTP server connection; 
