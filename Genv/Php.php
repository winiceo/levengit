...
/**
 * 
 * Lets you execute a Genv-based script in a separate PHP process, then get
 ...
 *     );
 *     
 *     $php = Genv::factory('Genv_Php');
 *     
 *     $php->setIniFile(false)
 *         ->setIniArray($ini)
 *         ->runGenvCode('echo "hello world!\n"');
 *     
 *     Genv::stop();
 * }}
 * 
 ...
 * 
 */
class Genv_Php extends Genv_Base
{
    /**
     * 
     ...
     * 
     * @config mixed Genv_config When calling Genv::start(), use this as the
     * config value.
     * 
    ...
    /**
     * 
     * When calling Genv::start() in the new process, use this as the $config
     * value.
     * 
     * @var mixed
     * 
     */
    protected $_Genv_config = null;
    ...
    protected function _postConstruct()
    {
        ...
        $list = array_keys($this->_Genv_Php);
        foreach ($list as $key) {
     ...
     * value.
     * 
     * @param mixed $Genv_config The value to use for Genv::start().
     * 
     * @return Genv_Php
     * 
     */
    public function setGenvConfig($Genv_config)
    {
        $this->_Genv_config = $Genv_config;
        return $this;
    }
    ...
    /**
     * 
     * Runs a file as a Genv script.
     * 
     * @param string $file The file to load as a Genv script.
     * 
     * @return Genv_Php
     * 
     */
    public function runGenv($file)
    {
        $code = file_get_contents($file);
        return $this->runGenvCode($code);
    }
    
    /**
     * 
     * Runs a code string as a Genv script.
     * 
     * @param string $code The code to run as a Genv script.
     * 
     * @return Genv_Php
     * 
     */
    public function runGenvCode($code)
    {
        $code = $this->_buildGenvCode($code);
     ...
     * 
     */
    protected function _buildGenvCode($code)
    {
        // the core code
        $code = $this->_buildCode($code);
        
        // get the Genv config as a variable
        $Genv_config = var_export($this->_Genv_config, true);
        
        // wrap the code in Genv::start() and Genv::stop()
        $code = "require 'Genv.php'; "
              . "Genv::start($Genv_config); "
              . "$code; "
              . "Genv::stop();";
