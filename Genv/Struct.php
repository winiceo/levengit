 ...
 *     $struct = Genv::factory('Genv_Struct', array('data' => $data));
 *     
 *     echo $struct['foo']; // 'bar'
 *     echo $struct->foo;   // 'bar'
 *     
 ...
 * {{code: php
 *     $data = array('foo' => 'bar', 'baz' => 'dib', 'zim' => 'gir');
 *     $object = Genv::factory('Genv_Struct', array('data' => $data));
 *     
 ...
 * 
 */
class Genv_Struct extends Genv_Base implements ArrayAccess, Countable, IteratorAggregate
{
    /**
     * 
    ...
    protected function _toArray($value)
    {
        ...
        } elseif ($value instanceof Genv_Struct) {
            // get Genv_Struct array
     ...
     * 
     * @param array|Genv_Struct $spec The data to load into the object.
     * 
     * @return void
     * 
     * @see _load()
    ...
    {
        // force to array
        if ($spec instanceof Genv_Struct) {
    ...
    protected function _free($value)
    {
        if (is_array($value)) {
            ...
            // recursively free child Genv_Struct objects
            $value->free();
        }
    }
     ...
     * 
     * @return Genv_Struct_Iterator
     * 
     */
    public function getIterator()
    {
        return new Genv_Struct_Iterator($this);
    }
