 ...
 * 
 */
class Genv_Struct_Xml extends Genv_Struct
{
    /**
     * 
     ...
     * 
     * @param Genv_Struct $parent The hierarchical parent of this struct.
     * 
     * @return void
     * 
     */
    public function setParent(Genv_Struct $parent)
    {
        $this->_parent = $parent;
    }
     ...
     * 
     * @return Genv_Struct The hierarchical parent of this struct.
     * 
     */
     ...
     * object.
     * 
     * Note that this behavior is **different** from the parent Genv_Struct,
     * where subsequent load() calls merge the data instead of overwriting.
     * 
     * @param string|array|Genv_Struct|SimpleXMLElement|DOMNode $spec Load 
    ...
    public function load($spec)
    {
        ...
        } elseif ($spec instanceof Genv_Struct) {
    ...
    /**
     * 
     * Support method to load data from a Genv_Struct.
     * 
     * @param Genv_Struct $struct The source data.
     * 
     * @return void
     * 
     * @see load()
     ...
     * array or Genv_Struct; **does not** retain XML attributes.
     * 
     ...
     * return as a Genv_Struct_Xml object.
     * 
     * @return array|Genv_Xml_Struct The converted SimpleXMLElement tree.
     * 
     */
