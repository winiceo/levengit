...
class Genv_Validate extends Genv_Base{
    /**
     * 内部数据
     *
     * @access private
     ...
     * @return	array
     * @throws  Genv_Validate_Exception
     */
    ...
    {
        return (Genv_Common::strLen($str) >= $length);
    }
